# best accuracy 58.36% epoch 35 -> shuffle: true
# best accuracy 58.68% epoch 46 -> shuffle: false
...
class Model(torch.nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.gru = nn.GRU(input_size=306, hidden_size=250, num_layers=2,
...
if __name__ == '__main__':
    ...
    validloader = DataLoader(valid, batch_size=64, shuffle=True)
